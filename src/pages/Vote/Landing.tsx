                ...
                <AutoColumn gap="md">
                  <RowBetween>
                    <ThemedText.DeprecatedWhite fontWeight={535}>
                      <Trans>Axodus governance</Trans>
                    </ThemedText.DeprecatedWhite>
                  </RowBetween>
                  <RowBetween>
                    <ThemedText.DeprecatedWhite fontSize={14}>
                      <Trans>
                        UNI tokens represent voting shares in Axodus governance. You can vote on each proposal yourself
                  ...
                  >
                    <ThemedText.DeprecatedWhite fontSize={14}>
                      <Trans>Read more about Axodus governance</Trans>
                    </ThemedText.DeprecatedWhite>
                  </ExternalLink>
                </AutoColumn>
              </CardSection>
