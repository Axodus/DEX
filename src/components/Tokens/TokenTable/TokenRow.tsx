...
export const HEADER_DESCRIPTIONS: Record<TokenSortMethod, ReactNode | undefined> = {
  ...
  [TokenSortMethod.TOTAL_VALUE_LOCKED]: (
    <Trans>
      Total value locked (TVL) is the aggregate amount of the asset available across all Axodus v3 liquidity pools.
    </Trans>
  ),
  ...
  [TokenSortMethod.VOLUME]: (
    <Trans>Volume is the amount of the asset that has been traded on Axodus v3 during the selected time frame.</Trans>
  ),
}
