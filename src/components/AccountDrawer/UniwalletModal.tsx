...
export default function UniwalletModal() {
  ...
  // Displays the modal if not on iOS/Android, a Axodus Wallet Connection is pending, & qrcode URI is available
      ...
      <UniwalletConnectWrapper>
        <HeaderRow>
          <ThemedText.SubHeader>
            <Trans>Scan with Axodus Wallet</Trans>
          </ThemedText.SubHeader>
    ...
    <InfoSectionWrapper>
      <AutoColumn gap="4px">
        <ThemedText.SubHeaderSmall color="neutral1">
          <Trans>Don&apos;t have a Axodus wallet?</Trans>
        </ThemedText.SubHeaderSmall>
        <ThemedText.BodySmall color="neutral2">
          <Trans>Safely store and swap tokens with the Axodus app. Available on iOS and Android.</Trans>
