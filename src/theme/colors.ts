...
export const colors = {
  ...
  magenta300: '#5CC6D0', //#FD82FF
  magentaVibrant: '#5CC6D0', //#FC72FF
  purple300: '#8440F2',
  purple900: '#1C0337',
  purpleVibrant: '#6100FF',
  // TODO: add all other vibrant variations
  networkEthereum: '#1F2933',
  networkOptimism: '#1F2933',
  networkOptimismSoft: '#1F2933',
  networkPolygon: '#1F2933',
  networkArbitrum: '#1F2933',
  networkBsc: '#1F2933',
  networkPolygonSoft: '#1F2933',
  networkEthereumSoft: '#1F2933',
  networkBase: '#1F2933',
  ...
  accent1_dark: '#5CC6D0', //#FC72FF
  accent2_dark: '#1C2931', //#311C31
...
const commonTheme = {
  ...
  chain_137_background: colors.networkPolygon,
  chain_10_background: colors.networkOptimism,
  chain_43114_background: colors.networkEthereum,
  chain_42161_background: colors.networkArbitrum,
